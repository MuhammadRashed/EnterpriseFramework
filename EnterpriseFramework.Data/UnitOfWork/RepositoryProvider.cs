...
{
    /// <summary>
    /// Provides an <see cref="IDataRepository{T}"/> for a client request.
    /// </summary>
    /// <remarks>
    /// Caches repositories of a given type so that repositories are only created once per provider.
    /// EnterpriseFramework.Data creates a new provider per client request.
    /// </remarks>
    public class RepositoryProvider<R> //: IRepositoryProvider
        where R : IDbContext
    {
        public RepositoryProvider(RepositoryFactories<R> repositoryFactories)
        {
        ...
        /// </summary>
        public R DbContext { get; set; }

        /// <summary>
        /// Get or create-and-cache the default <see cref="IDataRepository{T}"/> for an entity of type T.
        /// </summary>
        /// <typeparam name="T">
        /// Root entity type of the <see cref="IDataRepository{T}"/>.
        /// </typeparam>
        /// <remarks>
        /// If can't find repository in cache, use a factory to create one.
        /// </remarks>
        public IDataRepository<T> GetRepositoryForEntityType<T>() where T : class
        {
            return GetRepository<IDataRepository<T>>(
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<R, object> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<R, object> factory, R dbContext)
        {
        ...
        /// </remarks>
        private RepositoryFactories<R> _repositoryFactories;
